...
i18ndude rebuild-pot --pot ./locales/${DOMAIN}.pot --create ${DOMAIN} .  || exit 1
i18ndude sync --pot ./locales/${DOMAIN}.pot ./locales/*/LC_MESSAGES/${DOMAIN}.po

i18ndude rebuild-pot --pot ./locales/plone.pot --merge ./locales/plone-manual.pot --create plone ./profiles/default  || exit 1
